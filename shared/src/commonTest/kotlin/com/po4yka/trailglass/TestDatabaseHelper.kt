...
/** Helper for creating in-memory test databases. Uses expect/actual pattern for platform-specific drivers. */
object TestDatabaseHelper {
    /** Creates an in-memory Database for testing. Uses platform-specific driver (JDBC for JVM, Native for iOS). */
