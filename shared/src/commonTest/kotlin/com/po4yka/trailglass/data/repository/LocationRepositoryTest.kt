...
class LocationRepositoryTest {
    ...
    @Test
    fun `insertSample should store location sample successfully`() = runTest {
        // Given
    ...
    @Test
    fun `getSampleById should return inserted sample`() = runTest {
        // Given
    ...
    @Test
    fun `getSampleById should return null for non-existent sample`() = runTest {
        // When
    ...
    @Test
    fun `getSamples should return samples within time range`() = runTest {
        // Given
        ...
        // When
        val result = repository.getSamples(
            userId = userId,
            startTime = baseTime,
    ...
    @Test
    fun `getSamplesForTrip should return only samples for specific trip`() = runTest {
        // Given
    ...
    @Test
    fun `getUnprocessedSamples should return samples without trip ID`() = runTest {
        // Given
    ...
    @Test
    fun `getUnprocessedSamples should respect limit parameter`() = runTest {
        // Given
        repeat(5) { index ->
    ...
    @Test
    fun `updateTripId should assign trip to sample`() = runTest {
        // Given
    ...
    @Test
    fun `updateTripId should clear trip from sample`() = runTest {
        // Given
    ...
    @Test
    fun `deleteSample should soft delete sample`() = runTest {
        // Given
        val sample = createTestSample(id = "sample1")
        repository.insertSample(sample)
    ...
    @Test
    fun `deleteOldSamples should remove samples before given time`() = runTest {
        // Given
    ...
    @Test
    fun `should handle different location sources`() = runTest {
        // Given
    ...
    @Test
    fun `should store optional fields correctly`() = runTest {
        // Given
        val sampleWithOptionals = createTestSample(
            id = "with_optionals",
            speed = 25.5,
            bearing = 180.0,
            altitude = 100.5
        )
        val sampleWithoutOptionals = createTestSample(
