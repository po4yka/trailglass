...
class TrailGlassApiClient(
    ...
    suspend fun logout(): Result<Unit> {
        return authenticatedRequest { httpClient, token ->
    ...
    suspend fun getSyncStatus(): Result<SyncStatusResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/sync/status") {
                bearerAuth(token)
    ...
    suspend fun performDeltaSync(request: DeltaSyncRequest): Result<DeltaSyncResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.post("${config.baseUrl}/sync/delta") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun resolveConflict(request: ResolveConflictRequest): Result<ResolveConflictResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.post("${config.baseUrl}/sync/resolve-conflict") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun uploadLocationBatch(request: BatchLocationRequest): Result<BatchLocationResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.post("${config.baseUrl}/locations/batch") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun getLocations(
        ...
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/locations") {
                bearerAuth(token)
    ...
    suspend fun getPlaceVisits(
        ...
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/place-visits") {
                bearerAuth(token)
                parameter("startTime", startTime)
                parameter("endTime", endTime)
    ...
    suspend fun getPlaceVisit(id: String): Result<PlaceVisitDto> {
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/place-visits/$id") {
                bearerAuth(token)
            }.body<PlaceVisitDto>()
        }
    }
    ...
    suspend fun createPlaceVisit(request: CreatePlaceVisitRequest): Result<PlaceVisitResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.post("${config.baseUrl}/place-visits") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun updatePlaceVisit(id: String, request: UpdatePlaceVisitRequest): Result<PlaceVisitResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.put("${config.baseUrl}/place-visits/$id") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
            }.body<PlaceVisitResponse>()
    ...
    suspend fun getTrips(
        ...
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/trips") {
                bearerAuth(token)
    ...
    suspend fun createTrip(request: CreateTripRequest): Result<TripResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.post("${config.baseUrl}/trips") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
            }.body<TripResponse>()
    ...
    suspend fun updateTrip(id: String, request: UpdateTripRequest): Result<TripResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.put("${config.baseUrl}/trips/$id") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
            }.body<TripResponse>()
    ...
    suspend fun getSettings(): Result<SettingsDto> {
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/settings") {
                bearerAuth(token)
            }.body<SettingsDto>()
        }
    }
    ...
    suspend fun updateSettings(request: UpdateSettingsRequest): Result<SettingsResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.put("${config.baseUrl}/settings") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun getUserProfile(): Result<UserProfileDto> {
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/user/profile") {
                bearerAuth(token)
            }.body<UserProfileDto>()
        }
    }
    ...
    suspend fun updateUserProfile(request: UpdateUserProfileRequest): Result<UpdateUserProfileResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.put("${config.baseUrl}/user/profile") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun getUserDevices(): Result<UserDevicesResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/user/devices") {
                bearerAuth(token)
    ...
    suspend fun requestExport(request: DataExportRequest): Result<DataExportResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.post("${config.baseUrl}/export/request") {
                bearerAuth(token)
                contentType(ContentType.Application.Json)
                setBody(request)
    ...
    suspend fun getExportStatus(exportId: String): Result<ExportStatusResponse> {
        return authenticatedRequest { httpClient, token ->
            httpClient.get("${config.baseUrl}/export/$exportId/status") {
                bearerAuth(token)
