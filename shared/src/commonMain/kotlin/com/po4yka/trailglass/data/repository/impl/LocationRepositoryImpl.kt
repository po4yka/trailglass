...
class LocationRepositoryImpl(
    ...
    override suspend fun insertSample(sample: LocationSample): Result<Unit> = withContext(Dispatchers.IO) {
        resultOf {
    ...
    override suspend fun getSampleById(id: String): Result<LocationSample?> = withContext(Dispatchers.IO) {
        resultOf {
    ...
    override suspend fun getSamples(
        ...
        startTime: Instant,
        endTime: Instant
    ): Result<List<LocationSample>> = withContext(Dispatchers.IO) {
        resultOf {
    ...
    override suspend fun getUnprocessedSamples(userId: String, limit: Int): Result<List<LocationSample>> =
        withContext(Dispatchers.IO) {
            resultOf {
    ...
    override suspend fun updateTripId(sampleId: String, tripId: String?): Result<Unit> =
        withContext(Dispatchers.IO) {
            resultOf {
    ...
    override suspend fun deleteSample(id: String): Result<Unit> = withContext(Dispatchers.IO) {
        resultOf {
    ...
    override suspend fun deleteOldSamples(userId: String, beforeTime: Instant): Result<Unit> =
        withContext(Dispatchers.IO) {
            resultOf {
