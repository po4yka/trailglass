...
/**
 * Interface for recording raw location samples.
 * Platform-specific implementations forward location updates to this interface.
 */
interface LocationRecorder {
    ...
    /**
     * Process accumulated samples to build higher-level entities
     * (PlaceVisits, RouteSegments, etc.)
     */
