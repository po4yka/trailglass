...
/**
 * Provides marker icon information based on place category. Platform-specific implementations will use this to render
 * appropriate icons.
 */
object MarkerIconProvider {
    ...
    /**
     * Get route color based on transport type. Uses Silent Waters palette: Harbor Blue for historical routes. Active
     * routes should be set via explicit color parameter using Coastal Path.
     */
