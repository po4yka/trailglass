...
/**
 * Android implementation of ErrorMapper.
 * Maps Java/Android-specific exceptions to TrailGlassError instances.
 */
actual object ErrorMapper {
     ...
     */
    actual fun mapDatabaseException(exception: Throwable, operation: DatabaseOperation): TrailGlassError {
     ...
     */
    actual fun mapLocationException(exception: Throwable, context: LocationContext): TrailGlassError {
        return when (context) {
     ...
     */
    actual fun mapPhotoException(exception: Throwable, context: PhotoContext): TrailGlassError {
        return when (context) {
