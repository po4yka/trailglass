...
class TripsViewModel: ObservableObject {
    ...
    func toggleOngoingFilter() {
        let newOptions = controller.state.value.filterOptions.copy(showOngoing: !filterShowOngoing)
        controller.setFilterOptions(options: newOptions)
    }

    func toggleCompletedFilter() {
        let newOptions = controller.state.value.filterOptions.copy(showCompleted: !filterShowCompleted)
        controller.setFilterOptions(options: newOptions)
    }
