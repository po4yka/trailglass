    ...
    NavigationView {
        PlaceDetailView(
            place: FrequentPlace(
                ...
                firstVisitTime: Kotlinx_datetimeInstant.Companion().fromEpochSeconds(epochSeconds: 1609459200, nanosecondsOfSecond: 0),
                lastVisitTime: Kotlinx_datetimeInstant.Companion().fromEpochSeconds(epochSeconds: 1640995200, nanosecondsOfSecond: 0),
                userLabel: nil,
                userNotes: nil,
                isFavorite: true,
                userId: "user123",
                createdAt: Kotlinx_datetimeInstant.Companion().fromEpochSeconds(epochSeconds: 1609459200, nanosecondsOfSecond: 0),
                updatedAt: Kotlinx_datetimeInstant.Companion().fromEpochSeconds(epochSeconds: 1640995200, nanosecondsOfSecond: 0)
            ),
            onToggleFavorite: {},
            onDismiss: {}
        )
