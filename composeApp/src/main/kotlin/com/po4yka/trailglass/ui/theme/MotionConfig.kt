 ...
 *
 * Material 3 Expressive introduces enhanced motion schemes with spring-based animations
 * that provide more natural and delightful user experiences.
 *
 * This object provides predefined spring configurations aligned with Material 3 Expressive
 * motion guidelines for different use cases.
 *
 * Note: When Material3 1.5.0 becomes stable, consider migrating to MotionScheme.expressive()
